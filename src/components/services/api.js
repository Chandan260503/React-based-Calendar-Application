...
const apiClient = axios.create({
  baseURL: "https://react-based-calendar-application.onrender.com",
...
export const getCommunicationMethods = () =>
  apiClient.get("/communicationMethods");
...
export const addCommunicationToCompany = async (
  companyId,
  newCommunication
) => {
  try {
    const response = await apiClient.post(
      `/companies/${companyId}/lastCommunications`,
      newCommunication
    );
